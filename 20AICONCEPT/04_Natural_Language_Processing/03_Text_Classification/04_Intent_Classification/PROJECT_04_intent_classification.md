# 🚀 Project - 04 Intent Classification

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Intent Classification để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Intent Classification to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Intent Classification** / Deep understanding of 04 Intent Classification
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Intent Classification project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Intent Classification project
    '''
...
```python
def develop_04_intent_classification_model(X, y):
    '''
    Develop 04 Intent Classification model for project
    '''
...
```python
def optimize_04_intent_classification_model(X, y):
    '''
    Optimize 04 Intent Classification model using hyperparameter tuning
    '''
