# 🚀 Project - 03 Event Extraction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Event Extraction để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Event Extraction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Event Extraction** / Deep understanding of 03 Event Extraction
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Event Extraction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Event Extraction project
    '''
...
```python
def develop_03_event_extraction_model(X, y):
    '''
    Develop 03 Event Extraction model for project
    '''
...
```python
def optimize_03_event_extraction_model(X, y):
    '''
    Optimize 03 Event Extraction model using hyperparameter tuning
    '''
