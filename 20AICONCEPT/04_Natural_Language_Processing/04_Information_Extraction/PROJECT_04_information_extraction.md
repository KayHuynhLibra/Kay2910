# 🚀 Project - 04 Information Extraction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Information Extraction để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Information Extraction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Information Extraction** / Deep understanding of 04 Information Extraction
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Information Extraction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Information Extraction project
    '''
...
```python
def develop_04_information_extraction_model(X, y):
    '''
    Develop 04 Information Extraction model for project
    '''
...
```python
def optimize_04_information_extraction_model(X, y):
    '''
    Optimize 04 Information Extraction model using hyperparameter tuning
    '''
