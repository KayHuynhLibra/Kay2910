# 🚀 Project - 01 Entity Extraction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Entity Extraction để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Entity Extraction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Entity Extraction** / Deep understanding of 01 Entity Extraction
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Entity Extraction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Entity Extraction project
    '''
...
```python
def develop_01_entity_extraction_model(X, y):
    '''
    Develop 01 Entity Extraction model for project
    '''
...
```python
def optimize_01_entity_extraction_model(X, y):
    '''
    Optimize 01 Entity Extraction model using hyperparameter tuning
    '''
