# 🚀 Project - 02 Relation Extraction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Relation Extraction để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Relation Extraction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Relation Extraction** / Deep understanding of 02 Relation Extraction
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Relation Extraction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Relation Extraction project
    '''
...
```python
def develop_02_relation_extraction_model(X, y):
    '''
    Develop 02 Relation Extraction model for project
    '''
...
```python
def optimize_02_relation_extraction_model(X, y):
    '''
    Optimize 02 Relation Extraction model using hyperparameter tuning
    '''
