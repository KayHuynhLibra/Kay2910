# 🚀 Project - 03 Transformer Models

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Transformer Models để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Transformer Models to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Transformer Models** / Deep understanding of 03 Transformer Models
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Transformer Models project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Transformer Models project
    '''
...
```python
def develop_03_transformer_models_model(X, y):
    '''
    Develop 03 Transformer Models model for project
    '''
...
```python
def optimize_03_transformer_models_model(X, y):
    '''
    Optimize 03 Transformer Models model using hyperparameter tuning
    '''
