# 🚀 Project - 02 Language Models

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Language Models để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Language Models to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Language Models** / Deep understanding of 02 Language Models
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Language Models project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Language Models project
    '''
...
```python
def develop_02_language_models_model(X, y):
    '''
    Develop 02 Language Models model for project
    '''
...
```python
def optimize_02_language_models_model(X, y):
    '''
    Optimize 02 Language Models model using hyperparameter tuning
    '''
