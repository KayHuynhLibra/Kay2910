# 🚀 Project - 02 Lemmatization

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Lemmatization để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Lemmatization to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Lemmatization** / Deep understanding of 02 Lemmatization
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Lemmatization project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Lemmatization project
    '''
...
```python
def develop_02_lemmatization_model(X, y):
    '''
    Develop 02 Lemmatization model for project
    '''
...
```python
def optimize_02_lemmatization_model(X, y):
    '''
    Optimize 02 Lemmatization model using hyperparameter tuning
    '''
