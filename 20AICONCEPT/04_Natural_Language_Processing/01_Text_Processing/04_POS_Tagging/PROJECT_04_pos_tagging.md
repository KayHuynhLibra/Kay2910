# 🚀 Project - 04 Pos Tagging

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Pos Tagging để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Pos Tagging to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Pos Tagging** / Deep understanding of 04 Pos Tagging
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Pos Tagging project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Pos Tagging project
    '''
...
```python
def develop_04_pos_tagging_model(X, y):
    '''
    Develop 04 Pos Tagging model for project
    '''
...
```python
def optimize_04_pos_tagging_model(X, y):
    '''
    Optimize 04 Pos Tagging model using hyperparameter tuning
    '''
