# 🚀 Project - 04 Output Constraints

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Output Constraints để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Output Constraints to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Output Constraints** / Deep understanding of 04 Output Constraints
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Output Constraints project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Output Constraints project
    '''
...
```python
def develop_04_output_constraints_model(X, y):
    '''
    Develop 04 Output Constraints model for project
    '''
...
```python
def optimize_04_output_constraints_model(X, y):
    '''
    Optimize 04 Output Constraints model using hyperparameter tuning
    '''
