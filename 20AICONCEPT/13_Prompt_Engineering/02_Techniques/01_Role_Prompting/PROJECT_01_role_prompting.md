# 🚀 Project - 01 Role Prompting

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Role Prompting để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Role Prompting to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Role Prompting** / Deep understanding of 01 Role Prompting
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Role Prompting project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Role Prompting project
    '''
...
```python
def develop_01_role_prompting_model(X, y):
    '''
    Develop 01 Role Prompting model for project
    '''
...
```python
def optimize_01_role_prompting_model(X, y):
    '''
    Optimize 01 Role Prompting model using hyperparameter tuning
    '''
