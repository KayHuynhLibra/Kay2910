# 🚀 Project - 03 Prompt Optimizer

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Prompt Optimizer để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Prompt Optimizer to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Prompt Optimizer** / Deep understanding of 03 Prompt Optimizer
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Prompt Optimizer project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Prompt Optimizer project
    '''
...
```python
def develop_03_prompt_optimizer_model(X, y):
    '''
    Develop 03 Prompt Optimizer model for project
    '''
...
```python
def optimize_03_prompt_optimizer_model(X, y):
    '''
    Optimize 03 Prompt Optimizer model using hyperparameter tuning
    '''
