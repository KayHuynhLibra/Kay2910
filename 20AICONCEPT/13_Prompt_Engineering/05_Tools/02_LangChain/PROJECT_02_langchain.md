# 🚀 Project - 02 Langchain

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Langchain để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Langchain to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Langchain** / Deep understanding of 02 Langchain
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Langchain project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Langchain project
    '''
...
```python
def develop_02_langchain_model(X, y):
    '''
    Develop 02 Langchain model for project
    '''
...
```python
def optimize_02_langchain_model(X, y):
    '''
    Optimize 02 Langchain model using hyperparameter tuning
    '''
