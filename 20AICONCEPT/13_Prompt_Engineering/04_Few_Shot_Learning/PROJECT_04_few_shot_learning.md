# 🚀 Project - 04 Few Shot Learning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Few Shot Learning để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Few Shot Learning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Few Shot Learning** / Deep understanding of 04 Few Shot Learning
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Few Shot Learning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Few Shot Learning project
    '''
...
```python
def develop_04_few_shot_learning_model(X, y):
    '''
    Develop 04 Few Shot Learning model for project
    '''
...
```python
def optimize_04_few_shot_learning_model(X, y):
    '''
    Optimize 04 Few Shot Learning model using hyperparameter tuning
    '''
