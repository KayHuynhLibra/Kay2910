...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Context để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Context to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Context** / Deep understanding of 03 Context
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Context project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Context project
    '''
...
```python
def develop_03_context_model(X, y):
    '''
    Develop 03 Context model for project
    '''
...
```python
def optimize_03_context_model(X, y):
    '''
    Optimize 03 Context model using hyperparameter tuning
    '''
