...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Examples để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Examples to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Examples** / Deep understanding of 04 Examples
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Examples project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Examples project
    '''
...
```python
def develop_04_examples_model(X, y):
    '''
    Develop 04 Examples model for project
    '''
...
```python
def optimize_04_examples_model(X, y):
    '''
    Optimize 04 Examples model using hyperparameter tuning
    '''
