# 💻 Code Examples - 01 K Nearest Neighbors

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 k nearest neighbors.
...
### Example 1: Simple Implementation
    ...
    def simple_01_k_nearest_neighbors(X, y):
        """
        Simple implementation of 01 k nearest neighbors
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_k_nearest_neighbors(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01KNearestNeighbors:
        """
        Custom implementation of 01 k nearest neighbors
        """
