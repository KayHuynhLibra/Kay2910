# 🚀 Project - 01 K Nearest Neighbors

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 K Nearest Neighbors để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 K Nearest Neighbors to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 K Nearest Neighbors** / Deep understanding of 01 K Nearest Neighbors
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 K Nearest Neighbors project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 K Nearest Neighbors project
    '''
...
```python
def develop_01_k_nearest_neighbors_model(X, y):
    '''
    Develop 01 K Nearest Neighbors model for project
    '''
...
```python
def optimize_01_k_nearest_neighbors_model(X, y):
    '''
    Optimize 01 K Nearest Neighbors model using hyperparameter tuning
    '''
