# 🚀 Project - 04 Tree Based Methods

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Tree Based Methods để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Tree Based Methods to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Tree Based Methods** / Deep understanding of 04 Tree Based Methods
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Tree Based Methods project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Tree Based Methods project
    '''
...
```python
def develop_04_tree_based_methods_model(X, y):
    '''
    Develop 04 Tree Based Methods model for project
    '''
...
```python
def optimize_04_tree_based_methods_model(X, y):
    '''
    Optimize 04 Tree Based Methods model using hyperparameter tuning
    '''
