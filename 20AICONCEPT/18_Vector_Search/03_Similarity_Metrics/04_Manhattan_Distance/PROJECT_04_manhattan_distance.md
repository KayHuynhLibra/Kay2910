# 🚀 Project - 04 Manhattan Distance

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Manhattan Distance để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Manhattan Distance to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Manhattan Distance** / Deep understanding of 04 Manhattan Distance
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Manhattan Distance project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Manhattan Distance project
    '''
...
```python
def develop_04_manhattan_distance_model(X, y):
    '''
    Develop 04 Manhattan Distance model for project
    '''
...
```python
def optimize_04_manhattan_distance_model(X, y):
    '''
    Optimize 04 Manhattan Distance model using hyperparameter tuning
    '''
