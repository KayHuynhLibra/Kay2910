# 🚀 Project - 01 Semantic Search

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Semantic Search để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Semantic Search to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Semantic Search** / Deep understanding of 01 Semantic Search
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Semantic Search project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Semantic Search project
    '''
...
```python
def develop_01_semantic_search_model(X, y):
    '''
    Develop 01 Semantic Search model for project
    '''
...
```python
def optimize_01_semantic_search_model(X, y):
    '''
    Optimize 01 Semantic Search model using hyperparameter tuning
    '''
