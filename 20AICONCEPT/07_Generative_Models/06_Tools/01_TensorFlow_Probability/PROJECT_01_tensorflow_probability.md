# 🚀 Project - 01 Tensorflow Probability

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Tensorflow Probability để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Tensorflow Probability to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Tensorflow Probability** / Deep understanding of 01 Tensorflow Probability
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Tensorflow Probability project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Tensorflow Probability project
    '''
...
```python
def develop_01_tensorflow_probability_model(X, y):
    '''
    Develop 01 Tensorflow Probability model for project
    '''
...
```python
def optimize_01_tensorflow_probability_model(X, y):
    '''
    Optimize 01 Tensorflow Probability model using hyperparameter tuning
    '''
