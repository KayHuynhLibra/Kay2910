# 🚀 Project - 02 Pytorch Flows

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Pytorch Flows để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Pytorch Flows to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Pytorch Flows** / Deep understanding of 02 Pytorch Flows
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Pytorch Flows project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Pytorch Flows project
    '''
...
```python
def develop_02_pytorch_flows_model(X, y):
    '''
    Develop 02 Pytorch Flows model for project
    '''
...
```python
def optimize_02_pytorch_flows_model(X, y):
    '''
    Optimize 02 Pytorch Flows model using hyperparameter tuning
    '''
