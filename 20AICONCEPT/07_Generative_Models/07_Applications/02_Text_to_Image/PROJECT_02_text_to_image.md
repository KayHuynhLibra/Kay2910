# 🚀 Project - 02 Text To Image

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Text To Image để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Text To Image to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Text To Image** / Deep understanding of 02 Text To Image
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Text To Image project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Text To Image project
    '''
...
```python
def develop_02_text_to_image_model(X, y):
    '''
    Develop 02 Text To Image model for project
    '''
...
```python
def optimize_02_text_to_image_model(X, y):
    '''
    Optimize 02 Text To Image model using hyperparameter tuning
    '''
