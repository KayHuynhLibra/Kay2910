# 🚀 Project - 01 Normalizing Flows

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Normalizing Flows để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Normalizing Flows to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Normalizing Flows** / Deep understanding of 01 Normalizing Flows
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Normalizing Flows project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Normalizing Flows project
    '''
...
```python
def develop_01_normalizing_flows_model(X, y):
    '''
    Develop 01 Normalizing Flows model for project
    '''
...
```python
def optimize_01_normalizing_flows_model(X, y):
    '''
    Optimize 01 Normalizing Flows model using hyperparameter tuning
    '''
