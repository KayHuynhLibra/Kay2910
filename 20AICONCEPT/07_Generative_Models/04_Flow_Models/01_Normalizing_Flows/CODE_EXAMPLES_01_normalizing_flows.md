# 💻 Code Examples - 01 Normalizing Flows

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 normalizing flows.
...
### Example 1: Simple Implementation
    ...
    def simple_01_normalizing_flows(X, y):
        """
        Simple implementation of 01 normalizing flows
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_normalizing_flows(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01NormalizingFlows:
        """
        Custom implementation of 01 normalizing flows
        """
