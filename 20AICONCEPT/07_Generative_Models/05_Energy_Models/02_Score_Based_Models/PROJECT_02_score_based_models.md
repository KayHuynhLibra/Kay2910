# 🚀 Project - 02 Score Based Models

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Score Based Models để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Score Based Models to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Score Based Models** / Deep understanding of 02 Score Based Models
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Score Based Models project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Score Based Models project
    '''
...
```python
def develop_02_score_based_models_model(X, y):
    '''
    Develop 02 Score Based Models model for project
    '''
...
```python
def optimize_02_score_based_models_model(X, y):
    '''
    Optimize 02 Score Based Models model using hyperparameter tuning
    '''
