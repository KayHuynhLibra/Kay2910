# 💻 Code Examples - 04 Downstream Tasks

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 04 downstream tasks.
...
### Example 1: Simple Implementation
    ...
    def simple_04_downstream_tasks(X, y):
        """
        Simple implementation of 04 downstream tasks
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_04_downstream_tasks(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom04DownstreamTasks:
        """
        Custom implementation of 04 downstream tasks
        """
