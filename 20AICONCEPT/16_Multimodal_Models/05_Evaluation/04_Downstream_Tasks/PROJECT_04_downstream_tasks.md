# 🚀 Project - 04 Downstream Tasks

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Downstream Tasks để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Downstream Tasks to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Downstream Tasks** / Deep understanding of 04 Downstream Tasks
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Downstream Tasks project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Downstream Tasks project
    '''
...
```python
def develop_04_downstream_tasks_model(X, y):
    '''
    Develop 04 Downstream Tasks model for project
    '''
...
```python
def optimize_04_downstream_tasks_model(X, y):
    '''
    Optimize 04 Downstream Tasks model using hyperparameter tuning
    '''
