# 🚀 Project - 05 Outlier Handling

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Outlier Handling để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Outlier Handling to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Outlier Handling** / Deep understanding of 05 Outlier Handling
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Outlier Handling project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Outlier Handling project
    '''
...
```python
def develop_05_outlier_handling_model(X, y):
    '''
    Develop 05 Outlier Handling model for project
    '''
...
```python
def optimize_05_outlier_handling_model(X, y):
    '''
    Optimize 05 Outlier Handling model using hyperparameter tuning
    '''
