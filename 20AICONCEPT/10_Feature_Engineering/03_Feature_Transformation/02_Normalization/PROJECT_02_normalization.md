# 🚀 Project - 02 Normalization

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Normalization để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Normalization to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Normalization** / Deep understanding of 02 Normalization
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Normalization project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Normalization project
    '''
...
```python
def develop_02_normalization_model(X, y):
    '''
    Develop 02 Normalization model for project
    '''
...
```python
def optimize_02_normalization_model(X, y):
    '''
    Optimize 02 Normalization model using hyperparameter tuning
    '''
