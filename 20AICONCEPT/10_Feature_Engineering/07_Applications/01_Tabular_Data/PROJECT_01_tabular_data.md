# 🚀 Project - 01 Tabular Data

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Tabular Data để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Tabular Data to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Tabular Data** / Deep understanding of 01 Tabular Data
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Tabular Data project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Tabular Data project
    '''
...
```python
def develop_01_tabular_data_model(X, y):
    '''
    Develop 01 Tabular Data model for project
    '''
...
```python
def optimize_01_tabular_data_model(X, y):
    '''
    Optimize 01 Tabular Data model using hyperparameter tuning
    '''
