# 🚀 Project - 02 Text Data

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Text Data để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Text Data to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Text Data** / Deep understanding of 02 Text Data
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Text Data project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Text Data project
    '''
...
```python
def develop_02_text_data_model(X, y):
    '''
    Develop 02 Text Data model for project
    '''
...
```python
def optimize_02_text_data_model(X, y):
    '''
    Optimize 02 Text Data model using hyperparameter tuning
    '''
