...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Umap để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Umap to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Umap** / Deep understanding of 04 Umap
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Umap project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Umap project
    '''
...
```python
def develop_04_umap_model(X, y):
    '''
    Develop 04 Umap model for project
    '''
...
```python
def optimize_04_umap_model(X, y):
    '''
    Optimize 04 Umap model using hyperparameter tuning
    '''
