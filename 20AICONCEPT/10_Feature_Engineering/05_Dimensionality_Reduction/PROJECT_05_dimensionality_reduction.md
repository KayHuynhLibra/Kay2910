# 🚀 Project - 05 Dimensionality Reduction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Dimensionality Reduction để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Dimensionality Reduction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Dimensionality Reduction** / Deep understanding of 05 Dimensionality Reduction
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Dimensionality Reduction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Dimensionality Reduction project
    '''
...
```python
def develop_05_dimensionality_reduction_model(X, y):
    '''
    Develop 05 Dimensionality Reduction model for project
    '''
...
```python
def optimize_05_dimensionality_reduction_model(X, y):
    '''
    Optimize 05 Dimensionality Reduction model using hyperparameter tuning
    '''
