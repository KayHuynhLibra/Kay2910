# 💻 Code Examples - 03 Embedded Methods

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 03 embedded methods.
...
### Example 1: Simple Implementation
    ...
    def simple_03_embedded_methods(X, y):
        """
        Simple implementation of 03 embedded methods
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_03_embedded_methods(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom03EmbeddedMethods:
        """
        Custom implementation of 03 embedded methods
        """
