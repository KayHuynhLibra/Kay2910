# 🚀 Project - 01 Supervised Fine Tuning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Supervised Fine Tuning để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Supervised Fine Tuning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Supervised Fine Tuning** / Deep understanding of 01 Supervised Fine Tuning
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Supervised Fine Tuning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Supervised Fine Tuning project
    '''
...
```python
def develop_01_supervised_fine_tuning_model(X, y):
    '''
    Develop 01 Supervised Fine Tuning model for project
    '''
...
```python
def optimize_01_supervised_fine_tuning_model(X, y):
    '''
    Optimize 01 Supervised Fine Tuning model using hyperparameter tuning
    '''
