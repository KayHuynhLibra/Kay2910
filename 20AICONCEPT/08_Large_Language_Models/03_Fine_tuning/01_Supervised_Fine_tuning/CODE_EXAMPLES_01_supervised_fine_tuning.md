# 💻 Code Examples - 01 Supervised Fine Tuning

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 supervised fine tuning.
...
### Example 1: Simple Implementation
    ...
    def simple_01_supervised_fine_tuning(X, y):
        """
        Simple implementation of 01 supervised fine tuning
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_supervised_fine_tuning(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01SupervisedFineTuning:
        """
        Custom implementation of 01 supervised fine tuning
        """
