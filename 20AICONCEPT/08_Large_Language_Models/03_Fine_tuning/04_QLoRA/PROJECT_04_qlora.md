...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Qlora để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Qlora to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Qlora** / Deep understanding of 04 Qlora
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Qlora project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Qlora project
    '''
...
```python
def develop_04_qlora_model(X, y):
    '''
    Develop 04 Qlora model for project
    '''
...
```python
def optimize_04_qlora_model(X, y):
    '''
    Optimize 04 Qlora model using hyperparameter tuning
    '''
