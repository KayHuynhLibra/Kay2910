...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Data Preprocessing để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Data Preprocessing to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Data Preprocessing** / Deep understanding of 02 Data Preprocessing
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Data Preprocessing project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Data Preprocessing project
    '''
...
```python
def develop_02_data_preprocessing_model(X, y):
    '''
    Develop 02 Data Preprocessing model for project
    '''
...
```python
def optimize_02_data_preprocessing_model(X, y):
    '''
    Optimize 02 Data Preprocessing model using hyperparameter tuning
    '''
