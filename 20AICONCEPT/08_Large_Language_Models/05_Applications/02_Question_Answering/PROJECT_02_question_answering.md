# 🚀 Project - 02 Question Answering

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Question Answering để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Question Answering to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Question Answering** / Deep understanding of 02 Question Answering
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Question Answering project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Question Answering project
    '''
...
```python
def develop_02_question_answering_model(X, y):
    '''
    Develop 02 Question Answering model for project
    '''
...
```python
def optimize_02_question_answering_model(X, y):
    '''
    Optimize 02 Question Answering model using hyperparameter tuning
    '''
