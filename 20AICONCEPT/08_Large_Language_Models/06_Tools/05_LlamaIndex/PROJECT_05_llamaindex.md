# 🚀 Project - 05 Llamaindex

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Llamaindex để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Llamaindex to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Llamaindex** / Deep understanding of 05 Llamaindex
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Llamaindex project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Llamaindex project
    '''
...
```python
def develop_05_llamaindex_model(X, y):
    '''
    Develop 05 Llamaindex model for project
    '''
...
```python
def optimize_05_llamaindex_model(X, y):
    '''
    Optimize 05 Llamaindex model using hyperparameter tuning
    '''
