# 💻 Code Examples - 02 Openai Api

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 openai api.
...
### Example 1: Simple Implementation
    ...
    def simple_02_openai_api(X, y):
        """
        Simple implementation of 02 openai api
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_openai_api(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02OpenaiApi:
        """
        Custom implementation of 02 openai api
        """
