# 🚀 Project - 04 Langchain

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Langchain để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Langchain to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Langchain** / Deep understanding of 04 Langchain
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Langchain project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Langchain project
    '''
...
```python
def develop_04_langchain_model(X, y):
    '''
    Develop 04 Langchain model for project
    '''
...
```python
def optimize_04_langchain_model(X, y):
    '''
    Optimize 04 Langchain model using hyperparameter tuning
    '''
