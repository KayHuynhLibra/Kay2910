# 🚀 Project - 01 Hold Out Validation

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Hold Out Validation để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Hold Out Validation to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Hold Out Validation** / Deep understanding of 01 Hold Out Validation
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Hold Out Validation project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Hold Out Validation project
    '''
...
```python
def develop_01_hold_out_validation_model(X, y):
    '''
    Develop 01 Hold Out Validation model for project
    '''
...
```python
def optimize_01_hold_out_validation_model(X, y):
    '''
    Optimize 01 Hold Out Validation model using hyperparameter tuning
    '''
