# 🚀 Project - 04 Nested Cross Validation

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Nested Cross Validation để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Nested Cross Validation to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Nested Cross Validation** / Deep understanding of 04 Nested Cross Validation
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Nested Cross Validation project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Nested Cross Validation project
    '''
...
```python
def develop_04_nested_cross_validation_model(X, y):
    '''
    Develop 04 Nested Cross Validation model for project
    '''
...
```python
def optimize_04_nested_cross_validation_model(X, y):
    '''
    Optimize 04 Nested Cross Validation model using hyperparameter tuning
    '''
