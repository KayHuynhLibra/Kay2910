# 🚀 Project - 01 Feature Importance

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Feature Importance để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Feature Importance to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Feature Importance** / Deep understanding of 01 Feature Importance
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Feature Importance project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Feature Importance project
    '''
...
```python
def develop_01_feature_importance_model(X, y):
    '''
    Develop 01 Feature Importance model for project
    '''
...
```python
def optimize_01_feature_importance_model(X, y):
    '''
    Optimize 01 Feature Importance model using hyperparameter tuning
    '''
