# 🚀 Project - 05 Counterfactual Explanations

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Counterfactual Explanations để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Counterfactual Explanations to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Counterfactual Explanations** / Deep understanding of 05 Counterfactual Explanations
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Counterfactual Explanations project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Counterfactual Explanations project
    '''
...
```python
def develop_05_counterfactual_explanations_model(X, y):
    '''
    Develop 05 Counterfactual Explanations model for project
    '''
...
```python
def optimize_05_counterfactual_explanations_model(X, y):
    '''
    Optimize 05 Counterfactual Explanations model using hyperparameter tuning
    '''
