# 🚀 Project - 02 Fairness Metrics

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Fairness Metrics để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Fairness Metrics to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Fairness Metrics** / Deep understanding of 02 Fairness Metrics
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Fairness Metrics project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Fairness Metrics project
    '''
...
```python
def develop_02_fairness_metrics_model(X, y):
    '''
    Develop 02 Fairness Metrics model for project
    '''
...
```python
def optimize_02_fairness_metrics_model(X, y):
    '''
    Optimize 02 Fairness Metrics model using hyperparameter tuning
    '''
