# 🚀 Project - 04 Evidently

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Evidently để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Evidently to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Evidently** / Deep understanding of 04 Evidently
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Evidently project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Evidently project
    '''
...
```python
def develop_04_evidently_model(X, y):
    '''
    Develop 04 Evidently model for project
    '''
...
```python
def optimize_04_evidently_model(X, y):
    '''
    Optimize 04 Evidently model using hyperparameter tuning
    '''
