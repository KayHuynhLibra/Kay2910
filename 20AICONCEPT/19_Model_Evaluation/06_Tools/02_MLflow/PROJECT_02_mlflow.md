...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Mlflow để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Mlflow to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Mlflow** / Deep understanding of 02 Mlflow
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Mlflow project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Mlflow project
    '''
...
```python
def develop_02_mlflow_model(X, y):
    '''
    Develop 02 Mlflow model for project
    '''
...
```python
def optimize_02_mlflow_model(X, y):
    '''
    Optimize 02 Mlflow model using hyperparameter tuning
    '''
