# 🚀 Project - 01 Data Leakage

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Data Leakage để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Data Leakage to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Data Leakage** / Deep understanding of 01 Data Leakage
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Data Leakage project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Data Leakage project
    '''
...
```python
def develop_01_data_leakage_model(X, y):
    '''
    Develop 01 Data Leakage model for project
    '''
...
```python
def optimize_01_data_leakage_model(X, y):
    '''
    Optimize 01 Data Leakage model using hyperparameter tuning
    '''
