# 💻 Code Examples - 02 Multi Head Attention

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 multi head attention.
...
### Example 1: Simple Implementation
    ...
    def simple_02_multi_head_attention(X, y):
        """
        Simple implementation of 02 multi head attention
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_multi_head_attention(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02MultiHeadAttention:
        """
        Custom implementation of 02 multi head attention
        """
