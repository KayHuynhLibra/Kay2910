# 💻 Code Examples - 01 Self Attention

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 self attention.
...
### Example 1: Simple Implementation
    ...
    def simple_01_self_attention(X, y):
        """
        Simple implementation of 01 self attention
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_self_attention(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01SelfAttention:
        """
        Custom implementation of 01 self attention
        """
