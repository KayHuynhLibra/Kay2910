# 🚀 Project - 02 Bidirectional Lstm

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Bidirectional Lstm để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Bidirectional Lstm to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Bidirectional Lstm** / Deep understanding of 02 Bidirectional Lstm
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Bidirectional Lstm project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Bidirectional Lstm project
    '''
...
```python
def develop_02_bidirectional_lstm_model(X, y):
    '''
    Develop 02 Bidirectional Lstm model for project
    '''
...
```python
def optimize_02_bidirectional_lstm_model(X, y):
    '''
    Optimize 02 Bidirectional Lstm model using hyperparameter tuning
    '''
