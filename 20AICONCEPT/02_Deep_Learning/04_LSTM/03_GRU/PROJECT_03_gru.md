...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Gru để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Gru to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Gru** / Deep understanding of 03 Gru
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Gru project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Gru project
    '''
...
```python
def develop_03_gru_model(X, y):
    '''
    Develop 03 Gru model for project
    '''
...
```python
def optimize_03_gru_model(X, y):
    '''
    Optimize 03 Gru model using hyperparameter tuning
    '''
