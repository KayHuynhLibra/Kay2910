...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Rnn để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Rnn to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Rnn** / Deep understanding of 03 Rnn
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Rnn project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Rnn project
    '''
...
```python
def develop_03_rnn_model(X, y):
    '''
    Develop 03 Rnn model for project
    '''
...
```python
def optimize_03_rnn_model(X, y):
    '''
    Optimize 03 Rnn model using hyperparameter tuning
    '''
