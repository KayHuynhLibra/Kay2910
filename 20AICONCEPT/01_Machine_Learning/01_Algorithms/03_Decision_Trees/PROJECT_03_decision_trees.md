...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Decision Trees để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Decision Trees to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Decision Trees** / Deep understanding of 03 Decision Trees
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Decision Trees project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Decision Trees project
    '''
...
```python
def develop_03_decision_trees_model(X, y):
    '''
    Develop 03 Decision Trees model for project
    '''
...
```python
def optimize_03_decision_trees_model(X, y):
    '''
    Optimize 03 Decision Trees model using hyperparameter tuning
    '''
