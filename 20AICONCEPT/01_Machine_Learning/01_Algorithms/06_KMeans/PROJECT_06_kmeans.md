...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 06 Kmeans để giải quyết bài toán thực tế.

**English:** Build a complete system using 06 Kmeans to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 06 Kmeans** / Deep understanding of 06 Kmeans
...
def create_sample_dataset():
    '''
    Create sample dataset for 06 Kmeans project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 06 Kmeans project
    '''
...
```python
def develop_06_kmeans_model(X, y):
    '''
    Develop 06 Kmeans model for project
    '''
...
```python
def optimize_06_kmeans_model(X, y):
    '''
    Optimize 06 Kmeans model using hyperparameter tuning
    '''
