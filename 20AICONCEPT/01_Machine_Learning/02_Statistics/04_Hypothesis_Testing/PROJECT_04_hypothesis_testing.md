# 🚀 Project - 04 Hypothesis Testing

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Hypothesis Testing để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Hypothesis Testing to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Hypothesis Testing** / Deep understanding of 04 Hypothesis Testing
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Hypothesis Testing project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Hypothesis Testing project
    '''
...
```python
def develop_04_hypothesis_testing_model(X, y):
    '''
    Develop 04 Hypothesis Testing model for project
    '''
...
```python
def optimize_04_hypothesis_testing_model(X, y):
    '''
    Optimize 04 Hypothesis Testing model using hyperparameter tuning
    '''
