# 🚀 Project - 03 Probability

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Probability để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Probability to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Probability** / Deep understanding of 03 Probability
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Probability project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Probability project
    '''
...
```python
def develop_03_probability_model(X, y):
    '''
    Develop 03 Probability model for project
    '''
...
```python
def optimize_03_probability_model(X, y):
    '''
    Optimize 03 Probability model using hyperparameter tuning
    '''
