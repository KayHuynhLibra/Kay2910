# 🚀 Project - 02 Inferential Stats

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Inferential Stats để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Inferential Stats to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Inferential Stats** / Deep understanding of 02 Inferential Stats
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Inferential Stats project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Inferential Stats project
    '''
...
```python
def develop_02_inferential_stats_model(X, y):
    '''
    Develop 02 Inferential Stats model for project
    '''
...
```python
def optimize_02_inferential_stats_model(X, y):
    '''
    Optimize 02 Inferential Stats model using hyperparameter tuning
    '''
