# 🚀 Project - 03 Hierarchical Planning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Hierarchical Planning để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Hierarchical Planning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Hierarchical Planning** / Deep understanding of 03 Hierarchical Planning
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Hierarchical Planning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Hierarchical Planning project
    '''
...
```python
def develop_03_hierarchical_planning_model(X, y):
    '''
    Develop 03 Hierarchical Planning model for project
    '''
...
```python
def optimize_03_hierarchical_planning_model(X, y):
    '''
    Optimize 03 Hierarchical Planning model using hyperparameter tuning
    '''
