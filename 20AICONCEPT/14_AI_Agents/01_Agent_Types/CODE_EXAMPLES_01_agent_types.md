# 💻 Code Examples - 01 Agent Types

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 agent types.
...
### Example 1: Simple Implementation
    ...
    def simple_01_agent_types(X, y):
        """
        Simple implementation of 01 agent types
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_agent_types(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01AgentTypes:
        """
        Custom implementation of 01 agent types
        """
