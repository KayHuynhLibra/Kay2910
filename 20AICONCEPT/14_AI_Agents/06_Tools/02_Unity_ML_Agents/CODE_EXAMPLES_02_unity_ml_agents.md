# 💻 Code Examples - 02 Unity Ml Agents

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 unity ml agents.
...
### Example 1: Simple Implementation
    ...
    def simple_02_unity_ml_agents(X, y):
        """
        Simple implementation of 02 unity ml agents
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_unity_ml_agents(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02UnityMlAgents:
        """
        Custom implementation of 02 unity ml agents
        """
