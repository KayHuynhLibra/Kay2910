# 🗺️ Learning Roadmap - 02 Unity Ml Agents

## 🎯 Tổng Quan / Overview

**Tiếng Việt:** Lộ trình học tập chi tiết để thành thạo 02 Unity Ml Agents.

**English:** Detailed learning roadmap to master 02 Unity Ml Agents.
