# 🚀 Project - 02 Unity Ml Agents

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Unity Ml Agents để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Unity Ml Agents to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Unity Ml Agents** / Deep understanding of 02 Unity Ml Agents
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Unity Ml Agents project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Unity Ml Agents project
    '''
...
```python
def develop_02_unity_ml_agents_model(X, y):
    '''
    Develop 02 Unity Ml Agents model for project
    '''
...
```python
def optimize_02_unity_ml_agents_model(X, y):
    '''
    Optimize 02 Unity Ml Agents model using hyperparameter tuning
    '''
