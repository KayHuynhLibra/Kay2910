# 🚀 Project - 03 Double Dqn

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Double Dqn để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Double Dqn to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Double Dqn** / Deep understanding of 03 Double Dqn
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Double Dqn project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Double Dqn project
    '''
...
```python
def develop_03_double_dqn_model(X, y):
    '''
    Develop 03 Double Dqn model for project
    '''
...
```python
def optimize_03_double_dqn_model(X, y):
    '''
    Optimize 03 Double Dqn model using hyperparameter tuning
    '''
