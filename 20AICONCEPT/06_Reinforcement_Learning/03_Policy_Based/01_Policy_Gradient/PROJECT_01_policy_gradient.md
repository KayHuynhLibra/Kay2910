# 🚀 Project - 01 Policy Gradient

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Policy Gradient để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Policy Gradient to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Policy Gradient** / Deep understanding of 01 Policy Gradient
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Policy Gradient project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Policy Gradient project
    '''
...
```python
def develop_01_policy_gradient_model(X, y):
    '''
    Develop 01 Policy Gradient model for project
    '''
...
```python
def optimize_01_policy_gradient_model(X, y):
    '''
    Optimize 01 Policy Gradient model using hyperparameter tuning
    '''
