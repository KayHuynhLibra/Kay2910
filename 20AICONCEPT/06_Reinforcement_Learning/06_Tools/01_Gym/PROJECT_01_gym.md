...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Gym để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Gym to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Gym** / Deep understanding of 01 Gym
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Gym project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Gym project
    '''
...
```python
def develop_01_gym_model(X, y):
    '''
    Develop 01 Gym model for project
    '''
...
```python
def optimize_01_gym_model(X, y):
    '''
    Optimize 01 Gym model using hyperparameter tuning
    '''
