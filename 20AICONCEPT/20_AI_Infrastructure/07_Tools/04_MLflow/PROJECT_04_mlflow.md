...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Mlflow để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Mlflow to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Mlflow** / Deep understanding of 04 Mlflow
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Mlflow project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Mlflow project
    '''
...
```python
def develop_04_mlflow_model(X, y):
    '''
    Develop 04 Mlflow model for project
    '''
...
```python
def optimize_04_mlflow_model(X, y):
    '''
    Optimize 04 Mlflow model using hyperparameter tuning
    '''
