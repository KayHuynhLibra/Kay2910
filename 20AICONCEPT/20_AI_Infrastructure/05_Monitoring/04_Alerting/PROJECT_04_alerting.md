...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Alerting để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Alerting to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Alerting** / Deep understanding of 04 Alerting
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Alerting project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Alerting project
    '''
...
```python
def develop_04_alerting_model(X, y):
    '''
    Develop 04 Alerting model for project
    '''
...
```python
def optimize_04_alerting_model(X, y):
    '''
    Optimize 04 Alerting model using hyperparameter tuning
    '''
