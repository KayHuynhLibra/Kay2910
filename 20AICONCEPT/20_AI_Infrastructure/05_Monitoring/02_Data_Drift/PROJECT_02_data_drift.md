# 🚀 Project - 02 Data Drift

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Data Drift để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Data Drift to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Data Drift** / Deep understanding of 02 Data Drift
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Data Drift project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Data Drift project
    '''
...
```python
def develop_02_data_drift_model(X, y):
    '''
    Develop 02 Data Drift model for project
    '''
...
```python
def optimize_02_data_drift_model(X, y):
    '''
    Optimize 02 Data Drift model using hyperparameter tuning
    '''
