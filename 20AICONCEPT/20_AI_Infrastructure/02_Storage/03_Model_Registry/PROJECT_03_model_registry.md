# 🚀 Project - 03 Model Registry

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Model Registry để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Model Registry to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Model Registry** / Deep understanding of 03 Model Registry
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Model Registry project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Model Registry project
    '''
...
```python
def develop_03_model_registry_model(X, y):
    '''
    Develop 03 Model Registry model for project
    '''
...
```python
def optimize_03_model_registry_model(X, y):
    '''
    Optimize 03 Model Registry model using hyperparameter tuning
    '''
