# 🚀 Project - 03 Api Gateways

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Api Gateways để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Api Gateways to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Api Gateways** / Deep understanding of 03 Api Gateways
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Api Gateways project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Api Gateways project
    '''
...
```python
def develop_03_api_gateways_model(X, y):
    '''
    Develop 03 Api Gateways model for project
    '''
...
```python
def optimize_03_api_gateways_model(X, y):
    '''
    Optimize 03 Api Gateways model using hyperparameter tuning
    '''
