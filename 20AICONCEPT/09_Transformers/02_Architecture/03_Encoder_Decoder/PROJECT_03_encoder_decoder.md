# 🚀 Project - 03 Encoder Decoder

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Encoder Decoder để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Encoder Decoder to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Encoder Decoder** / Deep understanding of 03 Encoder Decoder
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Encoder Decoder project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Encoder Decoder project
    '''
...
```python
def develop_03_encoder_decoder_model(X, y):
    '''
    Develop 03 Encoder Decoder model for project
    '''
...
```python
def optimize_03_encoder_decoder_model(X, y):
    '''
    Optimize 03 Encoder Decoder model using hyperparameter tuning
    '''
