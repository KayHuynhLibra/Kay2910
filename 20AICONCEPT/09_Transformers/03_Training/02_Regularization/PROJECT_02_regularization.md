# 🚀 Project - 02 Regularization

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Regularization để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Regularization to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Regularization** / Deep understanding of 02 Regularization
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Regularization project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Regularization project
    '''
...
```python
def develop_02_regularization_model(X, y):
    '''
    Develop 02 Regularization model for project
    '''
...
```python
def optimize_02_regularization_model(X, y):
    '''
    Optimize 02 Regularization model using hyperparameter tuning
    '''
