# 🚀 Project - 04 Relative Attention

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Relative Attention để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Relative Attention to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Relative Attention** / Deep understanding of 04 Relative Attention
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Relative Attention project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Relative Attention project
    '''
...
```python
def develop_04_relative_attention_model(X, y):
    '''
    Develop 04 Relative Attention model for project
    '''
...
```python
def optimize_04_relative_attention_model(X, y):
    '''
    Optimize 04 Relative Attention model using hyperparameter tuning
    '''
