...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Semantic Segmentation để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Semantic Segmentation to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Semantic Segmentation** / Deep understanding of 01 Semantic Segmentation
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Semantic Segmentation project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Semantic Segmentation project
    '''
...
```python
def develop_01_semantic_segmentation_model(X, y):
    '''
    Develop 01 Semantic Segmentation model for project
    '''
...
```python
def optimize_01_semantic_segmentation_model(X, y):
    '''
    Optimize 01 Semantic Segmentation model using hyperparameter tuning
    '''
