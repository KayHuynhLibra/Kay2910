# 🚀 Project - 05 Mask Rcnn

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Mask Rcnn để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Mask Rcnn to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Mask Rcnn** / Deep understanding of 05 Mask Rcnn
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Mask Rcnn project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Mask Rcnn project
    '''
...
```python
def develop_05_mask_rcnn_model(X, y):
    '''
    Develop 05 Mask Rcnn model for project
    '''
...
```python
def optimize_05_mask_rcnn_model(X, y):
    '''
    Optimize 05 Mask Rcnn model using hyperparameter tuning
    '''
