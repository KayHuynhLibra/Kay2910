# 🚀 Project - 02 Instance Segmentation

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Instance Segmentation để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Instance Segmentation to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Instance Segmentation** / Deep understanding of 02 Instance Segmentation
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Instance Segmentation project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Instance Segmentation project
    '''
...
```python
def develop_02_instance_segmentation_model(X, y):
    '''
    Develop 02 Instance Segmentation model for project
    '''
...
```python
def optimize_02_instance_segmentation_model(X, y):
    '''
    Optimize 02 Instance Segmentation model using hyperparameter tuning
    '''
