...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 U Net để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 U Net to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 U Net** / Deep understanding of 04 U Net
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 U Net project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 U Net project
    '''
...
```python
def develop_04_u_net_model(X, y):
    '''
    Develop 04 U Net model for project
    '''
...
```python
def optimize_04_u_net_model(X, y):
    '''
    Optimize 04 U Net model using hyperparameter tuning
    '''
