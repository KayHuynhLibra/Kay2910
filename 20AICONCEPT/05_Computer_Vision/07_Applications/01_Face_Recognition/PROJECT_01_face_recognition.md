# 🚀 Project - 01 Face Recognition

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Face Recognition để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Face Recognition to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Face Recognition** / Deep understanding of 01 Face Recognition
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Face Recognition project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Face Recognition project
    '''
...
```python
def develop_01_face_recognition_model(X, y):
    '''
    Develop 01 Face Recognition model for project
    '''
...
```python
def optimize_01_face_recognition_model(X, y):
    '''
    Optimize 01 Face Recognition model using hyperparameter tuning
    '''
