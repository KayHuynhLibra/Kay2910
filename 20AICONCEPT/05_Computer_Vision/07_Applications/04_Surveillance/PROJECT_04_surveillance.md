# 🚀 Project - 04 Surveillance

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Surveillance để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Surveillance to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Surveillance** / Deep understanding of 04 Surveillance
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Surveillance project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Surveillance project
    '''
...
```python
def develop_04_surveillance_model(X, y):
    '''
    Develop 04 Surveillance model for project
    '''
...
```python
def optimize_04_surveillance_model(X, y):
    '''
    Optimize 04 Surveillance model using hyperparameter tuning
    '''
