# 🚀 Project - 04 Faster Rcnn

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Faster Rcnn để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Faster Rcnn to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Faster Rcnn** / Deep understanding of 04 Faster Rcnn
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Faster Rcnn project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Faster Rcnn project
    '''
...
```python
def develop_04_faster_rcnn_model(X, y):
    '''
    Develop 04 Faster Rcnn model for project
    '''
...
```python
def optimize_04_faster_rcnn_model(X, y):
    '''
    Optimize 04 Faster Rcnn model using hyperparameter tuning
    '''
