# 🚀 Project - 05 Mmdetection

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Mmdetection để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Mmdetection to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Mmdetection** / Deep understanding of 05 Mmdetection
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Mmdetection project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Mmdetection project
    '''
...
```python
def develop_05_mmdetection_model(X, y):
    '''
    Develop 05 Mmdetection model for project
    '''
...
```python
def optimize_05_mmdetection_model(X, y):
    '''
    Optimize 05 Mmdetection model using hyperparameter tuning
    '''
