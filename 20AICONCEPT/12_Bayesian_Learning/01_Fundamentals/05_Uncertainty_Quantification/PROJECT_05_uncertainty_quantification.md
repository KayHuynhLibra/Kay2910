# 🚀 Project - 05 Uncertainty Quantification

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Uncertainty Quantification để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Uncertainty Quantification to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Uncertainty Quantification** / Deep understanding of 05 Uncertainty Quantification
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Uncertainty Quantification project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Uncertainty Quantification project
    '''
...
```python
def develop_05_uncertainty_quantification_model(X, y):
    '''
    Develop 05 Uncertainty Quantification model for project
    '''
...
```python
def optimize_05_uncertainty_quantification_model(X, y):
    '''
    Optimize 05 Uncertainty Quantification model using hyperparameter tuning
    '''
