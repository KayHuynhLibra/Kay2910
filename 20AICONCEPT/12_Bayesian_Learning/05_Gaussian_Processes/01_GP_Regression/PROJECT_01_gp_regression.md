# 🚀 Project - 01 Gp Regression

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Gp Regression để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Gp Regression to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Gp Regression** / Deep understanding of 01 Gp Regression
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Gp Regression project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Gp Regression project
    '''
...
```python
def develop_01_gp_regression_model(X, y):
    '''
    Develop 01 Gp Regression model for project
    '''
...
```python
def optimize_01_gp_regression_model(X, y):
    '''
    Optimize 01 Gp Regression model using hyperparameter tuning
    '''
