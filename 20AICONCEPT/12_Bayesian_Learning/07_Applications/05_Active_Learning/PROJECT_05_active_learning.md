# 🚀 Project - 05 Active Learning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Active Learning để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Active Learning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Active Learning** / Deep understanding of 05 Active Learning
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Active Learning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Active Learning project
    '''
...
```python
def develop_05_active_learning_model(X, y):
    '''
    Develop 05 Active Learning model for project
    '''
...
```python
def optimize_05_active_learning_model(X, y):
    '''
    Optimize 05 Active Learning model using hyperparameter tuning
    '''
