# 💻 Code Examples - 02 Gibbs Sampling

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 gibbs sampling.
...
### Example 1: Simple Implementation
    ...
    def simple_02_gibbs_sampling(X, y):
        """
        Simple implementation of 02 gibbs sampling
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_gibbs_sampling(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02GibbsSampling:
        """
        Custom implementation of 02 gibbs sampling
        """
