# 🚀 Project - 02 Gibbs Sampling

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Gibbs Sampling để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Gibbs Sampling to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Gibbs Sampling** / Deep understanding of 02 Gibbs Sampling
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Gibbs Sampling project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Gibbs Sampling project
    '''
...
```python
def develop_02_gibbs_sampling_model(X, y):
    '''
    Develop 02 Gibbs Sampling model for project
    '''
...
```python
def optimize_02_gibbs_sampling_model(X, y):
    '''
    Optimize 02 Gibbs Sampling model using hyperparameter tuning
    '''
