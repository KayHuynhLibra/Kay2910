# 🚀 Project - 01 Metropolis Hastings

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Metropolis Hastings để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Metropolis Hastings to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Metropolis Hastings** / Deep understanding of 01 Metropolis Hastings
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Metropolis Hastings project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Metropolis Hastings project
    '''
...
```python
def develop_01_metropolis_hastings_model(X, y):
    '''
    Develop 01 Metropolis Hastings model for project
    '''
...
```python
def optimize_01_metropolis_hastings_model(X, y):
    '''
    Optimize 01 Metropolis Hastings model using hyperparameter tuning
    '''
