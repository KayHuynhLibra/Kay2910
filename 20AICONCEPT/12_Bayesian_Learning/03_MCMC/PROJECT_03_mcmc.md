...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Mcmc để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Mcmc to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Mcmc** / Deep understanding of 03 Mcmc
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Mcmc project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Mcmc project
    '''
...
```python
def develop_03_mcmc_model(X, y):
    '''
    Develop 03 Mcmc model for project
    '''
...
```python
def optimize_03_mcmc_model(X, y):
    '''
    Optimize 03 Mcmc model using hyperparameter tuning
    '''
