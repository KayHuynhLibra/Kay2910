# 💻 Code Examples - 03 Mcmc

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 03 mcmc.
...
### Example 1: Simple Implementation
    ...
    def simple_03_mcmc(X, y):
        """
        Simple implementation of 03 mcmc
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_03_mcmc(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom03Mcmc:
        """
        Custom implementation of 03 mcmc
        """
