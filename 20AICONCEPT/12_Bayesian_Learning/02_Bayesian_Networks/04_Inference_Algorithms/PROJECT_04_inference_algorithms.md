# 🚀 Project - 04 Inference Algorithms

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Inference Algorithms để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Inference Algorithms to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Inference Algorithms** / Deep understanding of 04 Inference Algorithms
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Inference Algorithms project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Inference Algorithms project
    '''
...
```python
def develop_04_inference_algorithms_model(X, y):
    '''
    Develop 04 Inference Algorithms model for project
    '''
...
```python
def optimize_04_inference_algorithms_model(X, y):
    '''
    Optimize 04 Inference Algorithms model using hyperparameter tuning
    '''
