# 🚀 Project - 02 Directed Graphs

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Directed Graphs để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Directed Graphs to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Directed Graphs** / Deep understanding of 02 Directed Graphs
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Directed Graphs project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Directed Graphs project
    '''
...
```python
def develop_02_directed_graphs_model(X, y):
    '''
    Develop 02 Directed Graphs model for project
    '''
...
```python
def optimize_02_directed_graphs_model(X, y):
    '''
    Optimize 02 Directed Graphs model using hyperparameter tuning
    '''
