# 🚀 Project - 04 Pytorch Probability

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Pytorch Probability để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Pytorch Probability to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Pytorch Probability** / Deep understanding of 04 Pytorch Probability
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Pytorch Probability project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Pytorch Probability project
    '''
...
```python
def develop_04_pytorch_probability_model(X, y):
    '''
    Develop 04 Pytorch Probability model for project
    '''
...
```python
def optimize_04_pytorch_probability_model(X, y):
    '''
    Optimize 04 Pytorch Probability model using hyperparameter tuning
    '''
