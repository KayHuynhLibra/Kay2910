# 🚀 Project - 03 Tensorflow Probability

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Tensorflow Probability để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Tensorflow Probability to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Tensorflow Probability** / Deep understanding of 03 Tensorflow Probability
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Tensorflow Probability project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Tensorflow Probability project
    '''
...
```python
def develop_03_tensorflow_probability_model(X, y):
    '''
    Develop 03 Tensorflow Probability model for project
    '''
...
```python
def optimize_03_tensorflow_probability_model(X, y):
    '''
    Optimize 03 Tensorflow Probability model using hyperparameter tuning
    '''
