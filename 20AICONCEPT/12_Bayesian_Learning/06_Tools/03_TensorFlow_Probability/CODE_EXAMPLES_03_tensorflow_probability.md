# 💻 Code Examples - 03 Tensorflow Probability

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 03 tensorflow probability.
...
### Example 1: Simple Implementation
    ...
    def simple_03_tensorflow_probability(X, y):
        """
        Simple implementation of 03 tensorflow probability
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_03_tensorflow_probability(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom03TensorflowProbability:
        """
        Custom implementation of 03 tensorflow probability
        """
