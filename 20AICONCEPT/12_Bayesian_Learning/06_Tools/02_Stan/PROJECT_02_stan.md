...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Stan để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Stan to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Stan** / Deep understanding of 02 Stan
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Stan project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Stan project
    '''
...
```python
def develop_02_stan_model(X, y):
    '''
    Develop 02 Stan model for project
    '''
...
```python
def optimize_02_stan_model(X, y):
    '''
    Optimize 02 Stan model using hyperparameter tuning
    '''
