# 💻 Code Examples - 02 Stan

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 stan.
...
### Example 1: Simple Implementation
    ...
    def simple_02_stan(X, y):
        """
        Simple implementation of 02 stan
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_stan(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02Stan:
        """
        Custom implementation of 02 stan
        """
