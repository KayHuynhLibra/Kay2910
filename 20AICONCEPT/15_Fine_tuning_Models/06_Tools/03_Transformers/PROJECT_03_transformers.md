# 🚀 Project - 03 Transformers

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Transformers để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Transformers to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Transformers** / Deep understanding of 03 Transformers
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Transformers project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Transformers project
    '''
...
```python
def develop_03_transformers_model(X, y):
    '''
    Develop 03 Transformers model for project
    '''
...
```python
def optimize_03_transformers_model(X, y):
    '''
    Optimize 03 Transformers model using hyperparameter tuning
    '''
