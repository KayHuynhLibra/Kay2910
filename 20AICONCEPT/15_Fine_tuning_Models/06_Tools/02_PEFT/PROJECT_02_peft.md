...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Peft để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Peft to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Peft** / Deep understanding of 02 Peft
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Peft project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Peft project
    '''
...
```python
def develop_02_peft_model(X, y):
    '''
    Develop 02 Peft model for project
    '''
...
```python
def optimize_02_peft_model(X, y):
    '''
    Optimize 02 Peft model using hyperparameter tuning
    '''
