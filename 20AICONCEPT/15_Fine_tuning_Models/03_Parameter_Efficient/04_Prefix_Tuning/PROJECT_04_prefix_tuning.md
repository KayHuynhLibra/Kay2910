# 🚀 Project - 04 Prefix Tuning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Prefix Tuning để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Prefix Tuning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Prefix Tuning** / Deep understanding of 04 Prefix Tuning
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Prefix Tuning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Prefix Tuning project
    '''
...
```python
def develop_04_prefix_tuning_model(X, y):
    '''
    Develop 04 Prefix Tuning model for project
    '''
...
```python
def optimize_04_prefix_tuning_model(X, y):
    '''
    Optimize 04 Prefix Tuning model using hyperparameter tuning
    '''
