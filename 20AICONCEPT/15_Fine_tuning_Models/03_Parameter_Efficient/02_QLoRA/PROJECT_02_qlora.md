...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Qlora để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Qlora to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Qlora** / Deep understanding of 02 Qlora
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Qlora project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Qlora project
    '''
...
```python
def develop_02_qlora_model(X, y):
    '''
    Develop 02 Qlora model for project
    '''
...
```python
def optimize_02_qlora_model(X, y):
    '''
    Optimize 02 Qlora model using hyperparameter tuning
    '''
