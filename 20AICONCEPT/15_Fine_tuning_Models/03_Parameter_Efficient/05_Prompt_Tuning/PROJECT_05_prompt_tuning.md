# 🚀 Project - 05 Prompt Tuning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Prompt Tuning để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Prompt Tuning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Prompt Tuning** / Deep understanding of 05 Prompt Tuning
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Prompt Tuning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Prompt Tuning project
    '''
...
```python
def develop_05_prompt_tuning_model(X, y):
    '''
    Develop 05 Prompt Tuning model for project
    '''
...
```python
def optimize_05_prompt_tuning_model(X, y):
    '''
    Optimize 05 Prompt Tuning model using hyperparameter tuning
    '''
