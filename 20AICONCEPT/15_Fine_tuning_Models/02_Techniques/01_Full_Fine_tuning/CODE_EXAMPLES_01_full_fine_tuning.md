# 💻 Code Examples - 01 Full Fine Tuning

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 full fine tuning.
...
### Example 1: Simple Implementation
    ...
    def simple_01_full_fine_tuning(X, y):
        """
        Simple implementation of 01 full fine tuning
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_full_fine_tuning(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01FullFineTuning:
        """
        Custom implementation of 01 full fine tuning
        """
