# 💻 Code Examples - 02 Partial Fine Tuning

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 partial fine tuning.
...
### Example 1: Simple Implementation
    ...
    def simple_02_partial_fine_tuning(X, y):
        """
        Simple implementation of 02 partial fine tuning
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_partial_fine_tuning(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02PartialFineTuning:
        """
        Custom implementation of 02 partial fine tuning
        """
