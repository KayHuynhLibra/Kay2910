# 🚀 Project - 02 Partial Fine Tuning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Partial Fine Tuning để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Partial Fine Tuning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Partial Fine Tuning** / Deep understanding of 02 Partial Fine Tuning
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Partial Fine Tuning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Partial Fine Tuning project
    '''
...
```python
def develop_02_partial_fine_tuning_model(X, y):
    '''
    Develop 02 Partial Fine Tuning model for project
    '''
...
```python
def optimize_02_partial_fine_tuning_model(X, y):
    '''
    Optimize 02 Partial Fine Tuning model using hyperparameter tuning
    '''
