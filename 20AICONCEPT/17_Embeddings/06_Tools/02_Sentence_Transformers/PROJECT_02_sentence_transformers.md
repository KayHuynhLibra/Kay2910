# 🚀 Project - 02 Sentence Transformers

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Sentence Transformers để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Sentence Transformers to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Sentence Transformers** / Deep understanding of 02 Sentence Transformers
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Sentence Transformers project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Sentence Transformers project
    '''
...
```python
def develop_02_sentence_transformers_model(X, y):
    '''
    Develop 02 Sentence Transformers model for project
    '''
...
```python
def optimize_02_sentence_transformers_model(X, y):
    '''
    Optimize 02 Sentence Transformers model using hyperparameter tuning
    '''
