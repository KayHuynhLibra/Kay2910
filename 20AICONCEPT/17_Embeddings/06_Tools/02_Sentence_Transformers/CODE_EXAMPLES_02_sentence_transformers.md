# 💻 Code Examples - 02 Sentence Transformers

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 sentence transformers.
...
### Example 1: Simple Implementation
    ...
    def simple_02_sentence_transformers(X, y):
        """
        Simple implementation of 02 sentence transformers
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_sentence_transformers(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02SentenceTransformers:
        """
        Custom implementation of 02 sentence transformers
        """
