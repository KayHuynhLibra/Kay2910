...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Word2Vec để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Word2Vec to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Word2Vec** / Deep understanding of 01 Word2Vec
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Word2Vec project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Word2Vec project
    '''
...
```python
def develop_01_word2vec_model(X, y):
    '''
    Develop 01 Word2Vec model for project
    '''
...
```python
def optimize_01_word2vec_model(X, y):
    '''
    Optimize 01 Word2Vec model using hyperparameter tuning
    '''
