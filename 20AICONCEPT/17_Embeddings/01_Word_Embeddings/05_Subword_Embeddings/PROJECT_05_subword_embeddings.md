# 🚀 Project - 05 Subword Embeddings

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Subword Embeddings để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Subword Embeddings to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Subword Embeddings** / Deep understanding of 05 Subword Embeddings
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Subword Embeddings project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Subword Embeddings project
    '''
...
```python
def develop_05_subword_embeddings_model(X, y):
    '''
    Develop 05 Subword Embeddings model for project
    '''
...
```python
def optimize_05_subword_embeddings_model(X, y):
    '''
    Optimize 05 Subword Embeddings model using hyperparameter tuning
    '''
