# 💻 Code Examples - 01 Node Embeddings

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 node embeddings.
...
### Example 1: Simple Implementation
    ...
    def simple_01_node_embeddings(X, y):
        """
        Simple implementation of 01 node embeddings
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_node_embeddings(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01NodeEmbeddings:
        """
        Custom implementation of 01 node embeddings
        """
