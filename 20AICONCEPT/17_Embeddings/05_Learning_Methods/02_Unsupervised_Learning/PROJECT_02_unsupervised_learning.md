# 🚀 Project - 02 Unsupervised Learning

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Unsupervised Learning để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Unsupervised Learning to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Unsupervised Learning** / Deep understanding of 02 Unsupervised Learning
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Unsupervised Learning project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Unsupervised Learning project
    '''
...
```python
def develop_02_unsupervised_learning_model(X, y):
    '''
    Develop 02 Unsupervised Learning model for project
    '''
...
```python
def optimize_02_unsupervised_learning_model(X, y):
    '''
    Optimize 02 Unsupervised Learning model using hyperparameter tuning
    '''
