# 💻 Code Examples - 02 Sentence Embeddings

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 02 sentence embeddings.
...
### Example 1: Simple Implementation
    ...
    def simple_02_sentence_embeddings(X, y):
        """
        Simple implementation of 02 sentence embeddings
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_02_sentence_embeddings(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom02SentenceEmbeddings:
        """
        Custom implementation of 02 sentence embeddings
        """
