# 💻 Code Examples - 01 Average Embeddings

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 average embeddings.
...
### Example 1: Simple Implementation
    ...
    def simple_01_average_embeddings(X, y):
        """
        Simple implementation of 01 average embeddings
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_average_embeddings(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01AverageEmbeddings:
        """
        Custom implementation of 01 average embeddings
        """
