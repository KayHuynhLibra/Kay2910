# 🚀 Project - 04 Universal Sentence Encoder

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Universal Sentence Encoder để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Universal Sentence Encoder to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Universal Sentence Encoder** / Deep understanding of 04 Universal Sentence Encoder
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Universal Sentence Encoder project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Universal Sentence Encoder project
    '''
...
```python
def develop_04_universal_sentence_encoder_model(X, y):
    '''
    Develop 04 Universal Sentence Encoder model for project
    '''
...
```python
def optimize_04_universal_sentence_encoder_model(X, y):
    '''
    Optimize 04 Universal Sentence Encoder model using hyperparameter tuning
    '''
