# 💻 Code Examples - 03 Sentence Transformers

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 03 sentence transformers.
...
### Example 1: Simple Implementation
    ...
    def simple_03_sentence_transformers(X, y):
        """
        Simple implementation of 03 sentence transformers
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_03_sentence_transformers(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom03SentenceTransformers:
        """
        Custom implementation of 03 sentence transformers
        """
