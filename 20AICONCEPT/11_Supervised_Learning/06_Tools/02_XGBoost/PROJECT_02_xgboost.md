...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Xgboost để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Xgboost to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Xgboost** / Deep understanding of 02 Xgboost
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Xgboost project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Xgboost project
    '''
...
```python
def develop_02_xgboost_model(X, y):
    '''
    Develop 02 Xgboost model for project
    '''
...
```python
def optimize_02_xgboost_model(X, y):
    '''
    Optimize 02 Xgboost model using hyperparameter tuning
    '''
