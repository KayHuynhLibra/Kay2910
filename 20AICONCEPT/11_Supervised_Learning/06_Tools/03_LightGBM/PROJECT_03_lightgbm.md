...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Lightgbm để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Lightgbm to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Lightgbm** / Deep understanding of 03 Lightgbm
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Lightgbm project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Lightgbm project
    '''
...
```python
def develop_03_lightgbm_model(X, y):
    '''
    Develop 03 Lightgbm model for project
    '''
...
```python
def optimize_03_lightgbm_model(X, y):
    '''
    Optimize 03 Lightgbm model using hyperparameter tuning
    '''
