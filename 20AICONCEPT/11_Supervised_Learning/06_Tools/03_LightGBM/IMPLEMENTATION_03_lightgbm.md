# 🛠️ Implementation Guide - 03 Lightgbm

## 🎯 Tổng Quan

Hướng dẫn chi tiết cách implement 03 lightgbm từ cơ bản đến nâng cao.
...
### Step 2: Model Implementation
    ...
    # Basic implementation
    def basic_03_lightgbm(X, y):
        """
        Basic implementation of 03 lightgbm
        Args:
            X: Input features
            y: Target variable
        Returns:
...
### Step 3: Training and Evaluation
    ...
    def train_and_evaluate(X, y):
        ...
        # Train model
        model = basic_03_lightgbm(X_train, y_train)
        # Make predictions
