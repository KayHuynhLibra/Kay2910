# 🚀 Project - 05 Confusion Matrix

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Confusion Matrix để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Confusion Matrix to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Confusion Matrix** / Deep understanding of 05 Confusion Matrix
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Confusion Matrix project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Confusion Matrix project
    '''
...
```python
def develop_05_confusion_matrix_model(X, y):
    '''
    Develop 05 Confusion Matrix model for project
    '''
...
```python
def optimize_05_confusion_matrix_model(X, y):
    '''
    Optimize 05 Confusion Matrix model using hyperparameter tuning
    '''
