# 🚀 Project - 02 Regression Metrics

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Regression Metrics để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Regression Metrics to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Regression Metrics** / Deep understanding of 02 Regression Metrics
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Regression Metrics project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Regression Metrics project
    '''
...
```python
def develop_02_regression_metrics_model(X, y):
    '''
    Develop 02 Regression Metrics model for project
    '''
...
```python
def optimize_02_regression_metrics_model(X, y):
    '''
    Optimize 02 Regression Metrics model using hyperparameter tuning
    '''
