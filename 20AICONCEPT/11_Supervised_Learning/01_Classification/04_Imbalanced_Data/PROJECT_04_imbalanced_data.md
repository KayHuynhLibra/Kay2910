# 🚀 Project - 04 Imbalanced Data

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Imbalanced Data để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Imbalanced Data to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Imbalanced Data** / Deep understanding of 04 Imbalanced Data
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Imbalanced Data project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Imbalanced Data project
    '''
...
```python
def develop_04_imbalanced_data_model(X, y):
    '''
    Develop 04 Imbalanced Data model for project
    '''
...
```python
def optimize_04_imbalanced_data_model(X, y):
    '''
    Optimize 04 Imbalanced Data model using hyperparameter tuning
    '''
