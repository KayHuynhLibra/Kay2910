# 🚀 Project - 01 Binary Classification

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Binary Classification để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Binary Classification to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Binary Classification** / Deep understanding of 01 Binary Classification
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Binary Classification project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Binary Classification project
    '''
...
```python
def develop_01_binary_classification_model(X, y):
    '''
    Develop 01 Binary Classification model for project
    '''
...
```python
def optimize_01_binary_classification_model(X, y):
    '''
    Optimize 01 Binary Classification model using hyperparameter tuning
    '''
