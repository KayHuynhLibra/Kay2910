# 🚀 Project - 02 Multiclass Classification

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Multiclass Classification để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Multiclass Classification to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Multiclass Classification** / Deep understanding of 02 Multiclass Classification
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Multiclass Classification project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Multiclass Classification project
    '''
...
```python
def develop_02_multiclass_classification_model(X, y):
    '''
    Develop 02 Multiclass Classification model for project
    '''
...
```python
def optimize_02_multiclass_classification_model(X, y):
    '''
    Optimize 02 Multiclass Classification model using hyperparameter tuning
    '''
