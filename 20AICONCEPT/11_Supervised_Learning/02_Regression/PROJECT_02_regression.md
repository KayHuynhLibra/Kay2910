...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Regression để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Regression to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Regression** / Deep understanding of 02 Regression
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Regression project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Regression project
    '''
...
```python
def develop_02_regression_model(X, y):
    '''
    Develop 02 Regression model for project
    '''
...
```python
def optimize_02_regression_model(X, y):
    '''
    Optimize 02 Regression model using hyperparameter tuning
    '''
