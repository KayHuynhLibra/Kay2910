...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Linear Regression để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Linear Regression to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Linear Regression** / Deep understanding of 01 Linear Regression
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Linear Regression project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Linear Regression project
    '''
...
```python
def develop_01_linear_regression_model(X, y):
    '''
    Develop 01 Linear Regression model for project
    '''
...
```python
def optimize_01_linear_regression_model(X, y):
    '''
    Optimize 01 Linear Regression model using hyperparameter tuning
    '''
