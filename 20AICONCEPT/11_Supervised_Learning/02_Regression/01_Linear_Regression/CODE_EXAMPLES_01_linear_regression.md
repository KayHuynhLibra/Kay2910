# 💻 Code Examples - 01 Linear Regression

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 01 linear regression.
...
### Example 1: Simple Implementation
    ...
    def simple_01_linear_regression(X, y):
        """
        Simple implementation of 01 linear regression
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_01_linear_regression(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom01LinearRegression:
        """
        Custom implementation of 01 linear regression
        """
