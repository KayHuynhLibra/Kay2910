# 🚀 Project - 04 Nonlinear Regression

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Nonlinear Regression để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Nonlinear Regression to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Nonlinear Regression** / Deep understanding of 04 Nonlinear Regression
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Nonlinear Regression project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Nonlinear Regression project
    '''
...
```python
def develop_04_nonlinear_regression_model(X, y):
    '''
    Develop 04 Nonlinear Regression model for project
    '''
...
```python
def optimize_04_nonlinear_regression_model(X, y):
    '''
    Optimize 04 Nonlinear Regression model using hyperparameter tuning
    '''
