...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 Polynomial Regression để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 Polynomial Regression to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 Polynomial Regression** / Deep understanding of 02 Polynomial Regression
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 Polynomial Regression project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 Polynomial Regression project
    '''
...
```python
def develop_02_polynomial_regression_model(X, y):
    '''
    Develop 02 Polynomial Regression model for project
    '''
...
```python
def optimize_02_polynomial_regression_model(X, y):
    '''
    Optimize 02 Polynomial Regression model using hyperparameter tuning
    '''
