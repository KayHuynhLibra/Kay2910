# 🚀 Project - 03 Clustering

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Clustering để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Clustering to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Clustering** / Deep understanding of 03 Clustering
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Clustering project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Clustering project
    '''
...
```python
def develop_03_clustering_model(X, y):
    '''
    Develop 03 Clustering model for project
    '''
...
```python
def optimize_03_clustering_model(X, y):
    '''
    Optimize 03 Clustering model using hyperparameter tuning
    '''
