# 🚀 Project - 04 Dimensionality Reduction

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Dimensionality Reduction để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Dimensionality Reduction to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Dimensionality Reduction** / Deep understanding of 04 Dimensionality Reduction
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Dimensionality Reduction project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Dimensionality Reduction project
    '''
...
```python
def develop_04_dimensionality_reduction_model(X, y):
    '''
    Develop 04 Dimensionality Reduction model for project
    '''
...
```python
def optimize_04_dimensionality_reduction_model(X, y):
    '''
    Optimize 04 Dimensionality Reduction model using hyperparameter tuning
    '''
