...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 01 Relu để giải quyết bài toán thực tế.

**English:** Build a complete system using 01 Relu to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 01 Relu** / Deep understanding of 01 Relu
...
def create_sample_dataset():
    '''
    Create sample dataset for 01 Relu project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 01 Relu project
    '''
...
```python
def develop_01_relu_model(X, y):
    '''
    Develop 01 Relu model for project
    '''
...
```python
def optimize_01_relu_model(X, y):
    '''
    Optimize 01 Relu model using hyperparameter tuning
    '''
