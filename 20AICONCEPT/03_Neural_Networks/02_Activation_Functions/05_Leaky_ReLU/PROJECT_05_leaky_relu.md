# 🚀 Project - 05 Leaky Relu

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 05 Leaky Relu để giải quyết bài toán thực tế.

**English:** Build a complete system using 05 Leaky Relu to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 05 Leaky Relu** / Deep understanding of 05 Leaky Relu
...
def create_sample_dataset():
    '''
    Create sample dataset for 05 Leaky Relu project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 05 Leaky Relu project
    '''
...
```python
def develop_05_leaky_relu_model(X, y):
    '''
    Develop 05 Leaky Relu model for project
    '''
...
```python
def optimize_05_leaky_relu_model(X, y):
    '''
    Optimize 05 Leaky Relu model using hyperparameter tuning
    '''
