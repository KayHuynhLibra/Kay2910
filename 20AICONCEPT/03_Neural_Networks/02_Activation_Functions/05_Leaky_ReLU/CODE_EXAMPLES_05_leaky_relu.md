# 💻 Code Examples - 05 Leaky Relu

## 🎯 Tổng Quan

Các ví dụ code thực tế cho 05 leaky relu.
...
### Example 1: Simple Implementation
    ...
    def simple_05_leaky_relu(X, y):
        """
        Simple implementation of 05 leaky relu
        Parameters:
    ...
    if __name__ == "__main__":
        ...
        # Train model
        model = simple_05_leaky_relu(X_train, y_train)
        # Make predictions
...
### Example 2: Custom Implementation
    ...
    class Custom05LeakyRelu:
        """
        Custom implementation of 05 leaky relu
        """
