# 🚀 Project - 03 Batch Normalization

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 03 Batch Normalization để giải quyết bài toán thực tế.

**English:** Build a complete system using 03 Batch Normalization to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 03 Batch Normalization** / Deep understanding of 03 Batch Normalization
...
def create_sample_dataset():
    '''
    Create sample dataset for 03 Batch Normalization project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 03 Batch Normalization project
    '''
...
```python
def develop_03_batch_normalization_model(X, y):
    '''
    Develop 03 Batch Normalization model for project
    '''
...
```python
def optimize_03_batch_normalization_model(X, y):
    '''
    Optimize 03 Batch Normalization model using hyperparameter tuning
    '''
