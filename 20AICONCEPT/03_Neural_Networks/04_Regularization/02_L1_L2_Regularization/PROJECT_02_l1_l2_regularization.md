# 🚀 Project - 02 L1 L2 Regularization

## 📋 Mô Tả Dự Án / Project Description

**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 02 L1 L2 Regularization để giải quyết bài toán thực tế.

**English:** Build a complete system using 02 L1 L2 Regularization to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 02 L1 L2 Regularization** / Deep understanding of 02 L1 L2 Regularization
...
def create_sample_dataset():
    '''
    Create sample dataset for 02 L1 L2 Regularization project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 02 L1 L2 Regularization project
    '''
...
```python
def develop_02_l1_l2_regularization_model(X, y):
    '''
    Develop 02 L1 L2 Regularization model for project
    '''
...
```python
def optimize_02_l1_l2_regularization_model(X, y):
    '''
    Optimize 02 L1 L2 Regularization model using hyperparameter tuning
    '''
