...
**Tiếng Việt:** Xây dựng một hệ thống hoàn chỉnh sử dụng 04 Metrics để giải quyết bài toán thực tế.

**English:** Build a complete system using 04 Metrics to solve a real-world problem.

## 🎯 Mục Tiêu / Objectives

1. **Hiểu sâu về 04 Metrics** / Deep understanding of 04 Metrics
...
def create_sample_dataset():
    '''
    Create sample dataset for 04 Metrics project
    '''
    np.random.seed(42)
    n_samples = 1000
...
def prepare_project_data(df):
    '''
    Prepare data for 04 Metrics project
    '''
...
```python
def develop_04_metrics_model(X, y):
    '''
    Develop 04 Metrics model for project
    '''
...
```python
def optimize_04_metrics_model(X, y):
    '''
    Optimize 04 Metrics model using hyperparameter tuning
    '''
